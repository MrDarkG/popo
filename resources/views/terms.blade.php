<div class="container">
		...
		<hr>
		<span class="terms-title">Interpretation</span><br>
		...
		<span class="terms-title">Definitions</span><br>
		...
		<ul>
			...
			<li>
				<b>Website</b>
				refers to Popo International, accessible from http://www.popo.ge
			</li>
			<li>
				<b>
					You 
		...
		<hr>
		<br>
		<span class="terms-title">Severability</span><br>

		<p>
			If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
		</p>

		<span class="terms-title">Waiver</span><br>
		...
		<br>
			...
			<ul>
				<li>By email: info@popo.ge</li>
				<li>By visiting this page on our website: http://www.popo.ge/contacts</li>
				<li>By phone number: +995 555 715 689</li>
			</ul>
