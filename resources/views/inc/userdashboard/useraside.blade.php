                ...
                <div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
                    ...
                    <div class="aside-logo d-flex flex-column align-items-center flex-column-auto py-4 pt-lg-10 pb-lg-7" id="kt_aside_logo">
                        <a href="/start/index.html">
                                <img alt="Logo" src="/assets/img/logo/logo.png" class="mh-50px" style="height:50px" />
                            </a>
                    </div>
                    <!--end::Logo-->
                    <!--begin::Nav Wrapper-->
                        ...
                        <div class="hover-scroll-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-offset="10px">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item mb-1" title="მთავარი გვერდი">
                                    <a href="{{ route('user_index') }}" class="nav-link h-40px w-40px h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white " id="main">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mb-1" title="კურსები" id="courses">
                                    <a href="{{ route('offers') }}" class="nav-link h-40px w-40px h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white" >
                                        <span class="svg-icon svg-icon-2 svg-icon-lg-1">
